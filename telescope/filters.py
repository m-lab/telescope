...
def filter_measurements_list(metric, measurements_list):
    """Applies measurement validition functions across a list of measurements.
      ...
      Args:
          ...
          measurements_list: (list) List of dicts with Measurement Lab and
              web100 variables for per measurement.

      Returns:
          dict: Dictionary with two lists, categorize with keep and discard
          lists based on validation but always actually retain for statistical
          purposes.
      """
    filter_functions = {
