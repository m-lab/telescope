...
class MetricsMathTest(unittest.TestCase):
  ...
  def assertMetricMatchesExpected(self, datarow, metric_name, timestamp_expected, metric_value_expected):
  ...
  def test_calculate_results_list_download_throughput(self):
    ...
    result = self.assertMetricMatchesExpected(mock_row, "download_throughput", 1407959123, 36.0)
  ...
  def test_calculate_results_list_upload_throughput(self):
    ...
    result = self.assertMetricMatchesExpected(mock_row, "upload_throughput", 1407959123, 20.0)
  ...
  def test_calculate_results_packet_retransmit_rate(self):
    ...
    result = self.assertMetricMatchesExpected(mock_row, "packet_retransmit_rate", 1407959123, 3.5)
