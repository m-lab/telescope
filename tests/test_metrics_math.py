...
class MetricsMathTest(unittest.TestCase):
    ...
    """
        ...
        result_rows = metrics_math.calculate_results_list(metric,
                                                          input_datarows)
    ...
    def test_calculate_results_list_minrtt(self):
        ...
        self.assertMetricMatchesExpected(mock_row, 'minimum_rtt', 1407959123,
                                         125)
    ...
    def test_calculate_results_list_avgrtt(self):
        ...
        self.assertMetricMatchesExpected(mock_row, 'average_rtt', 1407959123,
                                         2.5)
    ...
    def test_calculate_results_list_download_throughput(self):
        ...
        self.assertMetricMatchesExpected(mock_row, 'download_throughput',
                                         1407959123, 36.0)
    ...
    def test_calculate_results_list_upload_throughput(self):
        ...
        self.assertMetricMatchesExpected(mock_row, 'upload_throughput',
                                         1407959123, 20.0)
    ...
    def test_calculate_results_packet_retransmit_rate(self):
        ...
        self.assertMetricMatchesExpected(mock_row, 'packet_retransmit_rate',
                                         1407959123, 3.5)
